...
static std::map<std::string, std::string> logColors = {{"DEBUG", "\033[1;34m"},  {"INFO", "\033[1;32m"},     {"WARN", "\033[1;33m"},
                                                       {"ERROR", "\033[1;31m"},  {"CRITICAL", "\033[1;41m"}, {"RESET", "\033[0m"},
                                                       {"SRCLOC", "\033[1;30m"}, {"FUNCTION", "\033[1;35m"}};
