...
UIImage::UIImage(glm::vec2 position, glm::vec2 size, std::string eventToTrigger, AssetStringID imageStringID, AssetStringID textureAtlasStringID) : UIElement(position, size, eventToTrigger), image(MetaTexture{imageStringID, *assetManager.GetTextureAtlasData(imageStringID)}), textureAtlasStringID(textureAtlasStringID) {
