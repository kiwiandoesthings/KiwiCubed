...
public:
  ...
  Chunk(int chunkX, int chunkY, int chunkZ)
      : chunkX(chunkX), chunkY(chunkY), chunkZ(chunkZ), isEmpty(false) {}
...
public:
  ...
  void AddBlock(int chunkX, int chunkY, int chunkZ, int blockX, int blockY,
                int blockZ, unsigned short newBlockID);
  void RemoveBlock(int chunkX, int chunkY, int chunkZ, int blockX, int blockY,
                   int blockZ);
