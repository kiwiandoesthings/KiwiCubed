...
public:
  ...
  void RegisterKeyCallback(int key, KeyCallback callback) {
    ...
    int index =
        static_cast<int>(std::find(instances.begin(), instances.end(), this) -
                         instances.begin());
...
private:
  ...
  static void KeyCallbackHandler(GLFWwindow *window, int key, int scancode,
                                 int action, int mods) {
  ...
  static void MouseButtonCallbackHandler(GLFWwindow *window, int button,
                                         int action, int mods) {
    if (action == GLFW_PRESS) {
  ...
  static void ScrollCallbackHandler(GLFWwindow *, double xoffset,
                                    double yoffset) {
