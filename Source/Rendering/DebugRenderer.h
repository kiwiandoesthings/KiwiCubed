...
class DebugRenderer {
  public:
    ...
    void SetupBuffers(
        ...
        const std::vector<GLfloat> &chunkDebugVertices, const std::vector<GLuint> &chunkDebugIndices,
        const std::vector<glm::vec4> &chunkOrigins
    );
    void UpdateBuffers(
        const glm::vec3 &playerPhysicsBoundingBoxCorner1e, const glm::vec3 &playerPhysicsBoundingBoxCorner2,
        const glm::vec3 &playerPosition, const std::vector<GLfloat> &chunkDebugVertices, const std::vector<GLuint> &chunkDebugIndices,
        const std::vector<glm::vec4> &chunkOrigins
    );
